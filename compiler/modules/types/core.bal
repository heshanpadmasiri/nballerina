...
// JBUG: This is an approximation since we get a nullPtr exeception when we try to prepresent ty as a union
...
// represents record { ObjectField...; }  where ObjectField = { string kind; any value } | { string kind; readonly function value }
